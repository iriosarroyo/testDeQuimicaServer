...
export interface GeneralStats{
    ...
    n_correct: number,
    n_incorrect: number,
    n_incorrect_per_id: {[k:string]: number} |undefined
    n_questions: number,
    n_tests: number,
    sum_score: number,
    sum_defScore: number,
    ...
    fullName?:string,
    uids?: Set<string>,
    statsPerUser?: {[k:string]:GeneralStats},
    notDoneTest?:string[]
} 
...
export interface Averages{
    ...
    most_common_incorrect: {max: number, argsmax:string[]},

}

export interface GeneralStatsWUser extends GeneralStats{
    statsPerUser: {[k:string]:CompGeneralStats}
}

export type CompGeneralStats = GeneralStats & Averages
...
export interface GeneralTime{
    ...
    fullName?:string,
    uids?:Set<string>
    timesPerUser?:{[k:string]:GeneralTime}
    timesPerDay?:{[k:string]:GeneralTime}
}
